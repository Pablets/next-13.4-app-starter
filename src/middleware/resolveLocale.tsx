...
function findDomainFromHost(requestHeaders: Headers, domains: Array<DomainConfig>) {
...
function resolveLocaleFromDomain(
  ...
  if (domains) {
    ...
    if (domain) {
      return {
        locale:
          isLocaleSupportedOnDomain(localeFromPrefixStrategy, domain) || hasLocalePrefix
